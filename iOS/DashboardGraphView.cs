...
{
	public class DashboardGraphView : UIView
	{
		int _radius = 10;
		int _lineWidth = 10;
		nfloat _degrees = 0.0f;
		UIColor _backColor = UIColor.Green;
		UIColor _frontColor = UIColor.Black;
		...
		public DashboardGraphView (CGRect frame, int lineWidth, UIColor backColor, UIColor frontColor)
		{
			_lineWidth = lineWidth;
			this.Frame = new CGRect(frame.X, frame.Y, frame.Width, frame.Height);
			this.BackgroundColor = UIColor.Clear;
